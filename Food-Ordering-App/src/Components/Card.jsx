...
const Card = (props) => {
    ...
    // Object Destructuring
    const { name, cloudinaryImageId: img, cuisines, avgRating, costForTwo, locality, sla } = props?.res?.info;

    return (
        <div className="col-sm-3 mt-4">
            <div className="card bg-light">
                <img src={CLOUDINARY_IMG_URL + img} className="card-img-top img-thumbnail" style={{ aspectRatio: "3/2" }} alt="card-image" />
                <div className="card-body">
                    <h5 className="card-title">{name}</h5>
